...
export const getRepos = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
...
export const getRepoDetail = async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
